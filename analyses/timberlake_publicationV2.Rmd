...
plot.CH4.plant.autoScale <- ggplot(ghg.plant, aes(x=date_short, y=mg.CH4.N.m.2)) +
                     geom_boxplot(aes(color=treatment), outlier.shape = NA) +
                     geom_point(aes(color=treatment), size = 2, position = position_jitterdodge()) +
  scale_color_manual(values=c("#997700","#6699CC","#004488"), labels = c("Dry", "Interim", "Wet"), name="Treatment")+
  theme_bw() +
  #Remove plot grid lines
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
...
#ggsave("../figures/pub/Fig3/CH4_Inset.tiff", plot=plot.CH4.plant.autoScale, device="tiff", path=NULL, scale=1, width=7, height=6, dpi=600, limitsize=TRUE, bg="white")
...
#ggsave("../figures/pub/Fig3/N2O_Inset.tiff", plot=plot.N2O.plant.autoScale, device="tiff", path=NULL, scale=1, width=7, height=6, dpi=900, limitsize=TRUE, bg="white")
...
ch4.redox.regress.plot <- ggplot(soil.ghg[-c(17),])  +
  geom_point(aes(x=redox.percent.paint.removed, y=mg.CH4.N.m.2, color=plant), size=5)+ 
  scale_color_manual(values=c("gray", "darkgreen"), labels=c("No Plant", "Plant"), name = "") +
  scale_fill_manual(values=c("gray", "darkgreen")) +
  geom_smooth(aes(x=redox.percent.paint.removed, y=mg.CH4.N.m.2), method=lm, se=T, color="black")+
  ...
  theme_bw()  +
    ...
    theme(axis.ticks.length=unit(0.3,"cm")) + labs(x = "redox", y = expression(paste("mg CH"[4],"-C m"^{-2}))) + 
    theme(legend.text=element_text(size=14), legend.title = element_text(size=14), 
...
co2.redox.regress.plot <- ggplot(soil.ghg)  +
  geom_point(aes(x=redox.percent.paint.removed, y=mg.CO2.N.m.2, color=plant), size=5)+ 
  scale_color_manual(values=c("gray", "darkgreen"), labels=c("No Plant", "Plant"), name = "") +
  scale_fill_manual(values=c("gray", "darkgreen")) +
  geom_smooth(aes(x=redox.percent.paint.removed, y=mg.CO2.N.m.2), method=lm, se=T, color="black")+
  #annotate("text",x=4.0,y=7, size =7, label="C")+
  theme_bw()  +
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
          axis.title.y=element_text(margin=margin(r=10)), 
    ...
    theme(axis.title=element_text(vjust=1,size=18),
          axis.text=element_text(size=14), axis.text.x = element_text(size=14), panel.border =
          element_rect(colour = "black",size=1)) + 
    theme(axis.ticks.length=unit(0.3,"cm")) + labs(x = "redox", y = expression(paste("mg CO"[2],"-C m"^{-2}))) + 
    theme(legend.text=element_text(size=14), legend.title = element_text(size=14), 
          legend.position = "right")
...
n2o.redox.regress.plot <- ggplot(soil.ghg)  +
  geom_point(aes(x=redox.percent.paint.removed, y=mg.N2O.N.m.2, color=plant), size=5)+ 
  scale_color_manual(values=c("gray", "darkgreen"), labels=c("No Plant", "Plant"), name = "") +
  scale_fill_manual(values=c("gray", "darkgreen")) +
  geom_smooth(aes(x=redox.percent.paint.removed, y=mg.N2O.N.m.2), method=lm, se=T, color="black")+
  #annotate("text",x=4.0,y=7, size =7, label="C")+
  theme_bw()  +
    theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), 
          axis.title.y=element_text(margin=margin(r=10)), 
    ...
    theme(axis.title=element_text(vjust=1,size=18),
          axis.text=element_text(size=14), axis.text.x = element_text(size=14), panel.border =
          element_rect(colour = "black",size=1)) + 
    theme(axis.ticks.length=unit(0.3,"cm")) + labs(x = "redox", y = expression(paste("mg N"[2],"O-N m"^{-2}))) + 
    theme(legend.text=element_text(size=14), legend.title = element_text(size=14), 
          legend.position = "right")
