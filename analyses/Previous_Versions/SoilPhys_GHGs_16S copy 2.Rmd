...
## Figures for AP and Ardon proposal Feb 2025
...
# subset for 8.11 with interim (for March 2025 attempt at 16S PCoA recalculation):
select_fluxes_combined_w_T0_8.11 <- select_fluxes_combined_w_T0 %>% 
  subset(date_short == "8/11")
...
# Add GHG fluxes from final timepoint, August 11
...
vec$Y_nudge <- c(0, 0, 0, 0, 0, 0.01, -0.01, 0.02, 0, 0.02)
...
#ggsave("../figures/pub/16S_PCoA.tiff", plot=plot16S_PCoA, device="tiff", path=NULL, scale=1, width=9.5, height=5, dpi=600, limitsize=TRUE)
