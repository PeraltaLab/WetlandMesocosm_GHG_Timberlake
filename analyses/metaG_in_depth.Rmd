...
Mantel_heat_overall <- ggplot(combined, aes(Var1, Var2)) +
  ...
  geom_text(data = subset(combined, !mask), aes(label = label, color = text_color), size = 4) +
...
#ggsave("../figures/Fe_S_manuscript/MantelHeatHydro.tiff", plot=MantelHeatHydro_ALL, device="tiff", path=NULL, scale=1, width=11, height=9, dpi=600, limitsize=TRUE ,bg="white")
```
