...
# Make a list of all the metaG dfs:
metaG_data_list <- c(denit, meth, carb_metab, cytoCox, SO4_S_Assim, Assim_SO4_red, Dissim_SO4_red, ThioSOX, DNRA, ANRA, Nitrific, COMAMMOX, Nfix, CH4_ox, mtrBC_TIGR)

#length(metaG_data_list) #why is it 292?

#try some control structure stuff: #Not working!
for (i in metaG_data_list) {
  print(i)
}

# dm() didn't work either.
library(dm)

metaG_data_dm <- dm(denit, meth, carb_metab, cytoCox, SO4_S_Assim, Assim_SO4_red, Dissim_SO4_red, ThioSOX, DNRA, ANRA, Nitrific, COMAMMOX, Nfix, CH4_ox, mtrBC_TIGR)

names(metaG_data_dm)

for (i in metaG_data_dm) {
  print(names(i))
}
