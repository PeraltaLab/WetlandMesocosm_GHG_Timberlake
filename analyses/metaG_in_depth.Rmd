...
mantel(Dissim_SO4_redBC, methBC, permutations = 10000, set.seed(42))

mantel(Assim_SO4_redBC, methBC, permutations = 10000, set.seed(42))

mantel(SO4_red_combinedBC, methBC, permutations = 10000, set.seed(42))
...
```{r Hydrology-specific Mantel tests combined sulfate red and Fe red}
# Should Assim and Dissim sulfate red be added here as well?
...
# Sulfate reduction and methanogenesis in Wet history:
mantel(Assim_SO4_redRA_WetHist_BC, methRA_WetHist_BC, permutations = 10000, set.seed(42))

mantel(Dissim_SO4_redRA_WetHist_BC, methRA_WetHist_BC, permutations = 10000, set.seed(42))

# Sulfate reduction and methanogenesis in Dry history:
mantel(Assim_SO4_redRA_DryHist_BC, methRA_DryHist_BC, permutations = 10000, set.seed(42))

mantel(Dissim_SO4_redRA_DryHist_BC, methRA_DryHist_BC, permutations = 10000, set.seed(42))

# Sulfate reduction and methanogenesis in Wet treatment:
mantel(Assim_SO4_redRA_WetTreat_BC, methRA_WetTreat_BC, permutations = 10000, set.seed(42))

mantel(Dissim_SO4_redRA_WetTreat_BC, methRA_WetTreat_BC, permutations = 10000, set.seed(42))

# Sulfate reduction and methanogenesis in Dry treatment:
mantel(Assim_SO4_redRA_DryTreat_BC, methRA_DryTreat_BC, permutations = 10000, set.seed(42))

mantel(Dissim_SO4_redRA_DryTreat_BC, methRA_DryTreat_BC, permutations = 10000, set.seed(42))
```
