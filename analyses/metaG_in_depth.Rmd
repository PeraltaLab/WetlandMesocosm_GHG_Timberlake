...
fit_denit_SSF <- envfit(pcoa_denit$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
fit_denit_SSF
...
fit_denit_SFO <- envfit(pcoa_denit_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
fit_denit_SFO
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_meth_SSF <- envfit(pcoa_meth$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
fit_meth_SSF
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_meth_SFO <- envfit(pcoa_meth_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
fit_meth_SFO
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_carb_metab_SSF <- envfit(pcoa_carb_metab$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
fit_carb_metab_SSF
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_carb_metab_SFO <- envfit(pcoa_carb_metab_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
fit_carb_metab_SFO
...
plot3c <- ggplot(df3c, aes(x=V1, y=V2, shape=history_plant, colour=trt)) + geom_errorbarh(aes(xmax=V1+V1e, xmin=V1-V1e, height=0.003), colour="black") +    
 ...
 geom_text(data=vec_carb_metab_SFO, aes(x=Dim1, y=Dim2), label=vec_carb_metab_SFO$labels, size=3, check_overlap = T, nudge_x = 0.01, inherit.aes=F)+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
  theme(panel.background = element_blank()) + 
  theme(axis.title = element_text(size=14), axis.text=element_text(size=14), 
          axis.text.x = element_text(size=14),  axis.text.y = element_text(size=14),
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_cytoCox_SSF <- envfit(pcoa_cytoCox$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
fit_cytoCox_SSF
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_cytoCox_SFO <- envfit(pcoa_cytoCox_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
fit_cytoCox_SFO
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_SO4_S_Assim_SSF <- envfit(pcoa_SO4_S_Assim$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
fit_SO4_S_Assim_SSF
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_SO4_S_Assim_SFO <- envfit(pcoa_SO4_S_Assim_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
fit_SO4_S_Assim_SFO
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_Assim_SO4_red_SSF <- envfit(pcoa_Assim_SO4_red$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
...
vec_Assim_SO4_red_SSF$X_nudge <- c(0.02, 0)
...
plot4b <- ggplot(df4b, aes(x=V1, y=V2, shape=history_plant, colour=trt)) + geom_errorbarh(aes(xmax=V1+V1e, xmin=V1-V1e, height=0.003), colour="black") +    
 ...
 geom_text(data=vec_Assim_SO4_red_SSF, aes(x=Dim1, y=Dim2), label= c(expression(paste("mg CO"[2],"-C m"^{-2})), "%paint removed (redox)"), size=3, nudge_x = vec_Assim_SO4_red_SSF$X_nudge, nudge_y = vec_Assim_SO4_red_SSF$Y_nudge, inherit.aes=F)+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
  theme(panel.background = element_blank()) + 
  theme(axis.title = element_text(size=14), axis.text=element_text(size=14), 
          axis.text.x = element_text(size=14),  axis.text.y = element_text(size=14),
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_Assim_SO4_red_SFO <- envfit(pcoa_Assim_SO4_red_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_Dissim_SO4_red_SSF <- envfit(pcoa_Dissim_SO4_red$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_Dissim_SO4_red_SFO <- envfit(pcoa_Dissim_SO4_red_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
...
plot5c <- ggplot(df5c, aes(x=V1, y=V2, shape=history_plant, colour=trt)) + geom_errorbarh(aes(xmax=V1+V1e, xmin=V1-V1e, height=0.003), colour="black") +    
 ...
 geom_text(data=vec_Dissim_SO4_red_SFO, aes(x=Dim1+0.001, y=Dim2+0.005), label=vec_Dissim_SO4_red_SFO$labels, size=3.5, inherit.aes=F)+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
  theme(panel.background = element_blank()) + 
  theme(axis.title = element_text(size=14), axis.text=element_text(size=14), 
          axis.text.x = element_text(size=14),  axis.text.y = element_text(size=14),
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_ThioSOX_SSF <- envfit(pcoa_ThioSOX$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
fit_ThioSOX_SSF
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_ThioSOX_SFO <- envfit(pcoa_ThioSOX_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
fit_ThioSOX_SFO
...
plot5d <- ggplot(df5d, aes(x=V1, y=V2, shape=history_plant, colour=trt)) + geom_errorbarh(aes(xmax=V1+V1e, xmin=V1-V1e, height=0.003), colour="black") +    
 ...
 geom_text(data=vec_ThioSOX_SFO, aes(x=Dim1+0.003, y=Dim2+0.006), label=vec_ThioSOX_SFO$labels, nudge_x = vec_ThioSOX_SFO$X_nudge, nudge_y = vec_ThioSOX_SFO$Y_nudge, size=3.5, inherit.aes=F)+
  theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) + 
  theme(panel.background = element_blank()) + 
  theme(axis.title = element_text(size=14), axis.text=element_text(size=14), 
          axis.text.x = element_text(size=14),  axis.text.y = element_text(size=14),
...
#ggsave("../figures/Thesis/S_pcoa4panel_SSF.jpg", plot = S_pcoa_4panel_SSF, device=NULL, path=NULL, scale=1, height = 7, width = 12, limitsize = TRUE, dpi = 600)
...
#ggsave("../figures/Thesis/S_pcoa4panel_SFO.jpg", plot = S_pcoa_4panel_SFO, device=NULL, path=NULL, scale=1, height = 7, width = 12, limitsize = TRUE, dpi = 600)
```
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_FeGenie_SSF <- envfit(pcoa_FeGenie$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
fit_FeGenie_SSF
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_FeGenie_SFO <- envfit(pcoa_FeGenie_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
fit_FeGenie_SFO
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_FeReduction_SSF <- envfit(pcoa_FeReduction$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
fit_FeReduction_SSF
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_FeReduction_SFO <- envfit(pcoa_FeReduction_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
fit_FeReduction_SFO
...
#Run envfit with new Soil data (SSF = Soil Start & Finish):
fit_SO4_red_combined_SSF <- envfit(pcoa_SO4_red_combined$points, SoilGHG_StartFinish_Envfit, permutations = 10000, set.seed(42))
...
#Run envfit with new Soil data (SFO = Soil Finish Only):
fit_SO4_red_combined_SFO <- envfit(pcoa_SO4_red_combined_FINAL$points, envfit_FINISH_numerical, permutations = 10000, set.seed(42))
