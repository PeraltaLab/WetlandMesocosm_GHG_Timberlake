...
#ggsave("../figures/Fe_S_manuscript/Figure5.tiff", plot = S_pcoa_4panel_SSF, device="tiff", path=NULL, scale=1, height = 7, width = 12, limitsize = TRUE, dpi = 600)
...
#ggsave("../figures/Fe_S_manuscript/Figure6.tiff", plot = FeRed_SO4Red_4panel, device="tiff", path=NULL, scale=1, height = 7, width = 13, limitsize = TRUE, dpi = 600)
```
...
# Example distance matrices (replace with your actual matrices)
matrices <- list(
  FeR = FeReductionBC,
  ASR = Assim_SO4_redBC,
  DSR = Dissim_SO4_redBC,
  SOX = ThioSOXBC,
  Denit = denitBC,
  DNRA = DNRABC,
  Methano = methBC
...
for (i in 1:n) {
  for (j in 1:n) {
    test <- mantel(matrices[[i]], matrices[[j]], permutations = 10000, set.seed(42))
...
# Format p-values
combined$p_formatted <- ifelse(combined$p < 0.01,
                               formatC(combined$p, format = "e", digits = 1),
                               formatC(combined$p, format = "f", digits = 2))

# Create label
combined$label <- paste0("r=", formatC(combined$r, digits = 2, format = "f"),
                         "\n", "p=", combined$p_formatted)
...
Mantel_heat_overall <- ggplot(combined, aes(Var1, Var2)) +
  ...
  geom_text(data = subset(combined, !mask), aes(label = label), size = 4, color = "white") +
  scale_fill_viridis_c(option = "viridis", name = "Mantel r") +
...
#ggsave("../figures/Fe_S_manuscript/Mantel_heat_overall.tiff", plot=Mantel_heat_overall, device="tiff", path=NULL, scale=1, width=9, height=5, dpi=600, limitsize=TRUE ,bg="white")
```
...
matrices <- list(
  FeR = FeReductionRA_WetHist_BC,
  ASR = Assim_SO4_redRA_WetHist_BC,
  DSR = Dissim_SO4_redRA_WetHist_BC,
  Methano = methRA_WetHist_BC
)
...
# Plot heatmap with masked lower triangle
MantelHeatHydro_1 <- ggplot(combined, aes(Var1, Var2)) +
  geom_tile(data = subset(combined, mask), fill = "white", color = "white") +
  geom_tile(data = subset(combined, !mask), aes(fill = r), color = "white") +
  geom_text(data = subset(combined, !mask), aes(label = label), size = 4, color = "white") +
  scale_fill_viridis_c(option = "viridis", name = "Mantel r") +
...
# Distance matrices, wet history only
matrices <- list(
  FeR = FeReductionRA_DryHist_BC,
  ASR = Assim_SO4_redRA_DryHist_BC,
  DSR = Dissim_SO4_redRA_DryHist_BC,
  Methano = methRA_DryHist_BC
)
...
# Plot heatmap with masked lower triangle
MantelHeatHydro_2 <- ggplot(combined, aes(Var1, Var2)) +
  geom_tile(data = subset(combined, mask), fill = "white", color = "white") +
  geom_tile(data = subset(combined, !mask), aes(fill = r), color = "white") +
  geom_text(data = subset(combined, !mask), aes(label = label), size = 4, color = "white") +
  scale_fill_viridis_c(option = "viridis", name = "Mantel r") +
...
# Distance matrices, wet history only
matrices <- list(
  FeR = FeReductionRA_WetTreat_BC,
  ASR = Assim_SO4_redRA_WetTreat_BC,
  DSR = Dissim_SO4_redRA_WetTreat_BC,
  Methano = methRA_WetTreat_BC
)
...
# Plot heatmap with masked lower triangle
MantelHeatHydro_3 <- ggplot(combined, aes(Var1, Var2)) +
  geom_tile(data = subset(combined, mask), fill = "white", color = "white") +
  geom_tile(data = subset(combined, !mask), aes(fill = r), color = "white") +
  geom_text(data = subset(combined, !mask), aes(label = label), size = 4, color = "white") +
  scale_fill_viridis_c(option = "viridis", name = "Mantel r") +
...
# Distance matrices, wet history only
matrices <- list(
  FeR = FeReductionRA_DryTreat_BC,
  ASR = Assim_SO4_redRA_DryTreat_BC,
  DSR = Dissim_SO4_redRA_DryTreat_BC,
  Methano = methRA_DryTreat_BC
)
...
# Plot heatmap with masked lower triangle
MantelHeatHydro_4 <- ggplot(combined, aes(Var1, Var2)) +
  geom_tile(data = subset(combined, mask), fill = "white", color = "white") +
  geom_tile(data = subset(combined, !mask), aes(fill = r), color = "white") +
  geom_text(data = subset(combined, !mask), aes(label = label), size = 4, color = "white") +
  scale_fill_viridis_c(option = "viridis", name = "Mantel r") +
...
MantelHeatHydro_ALL <- ggarrange(MantelHeatHydro_1, MantelHeatHydro_2, MantelHeatHydro_3, MantelHeatHydro_4, labels = c("A", "B", "C", "D"), ncol = 2, nrow = 2, legend = "right", common.legend = T)

MantelHeatHydro_ALL

#ggsave("../figures/Fe_S_manuscript/MantelHeatHydro.tiff", plot=MantelHeatHydro_ALL, device="tiff", path=NULL, scale=1, width=9, height=7, dpi=600, limitsize=TRUE ,bg="white")
```
