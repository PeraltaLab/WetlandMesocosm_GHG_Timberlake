...
for (i in 1:n) {
  for (j in 1:n) {
    test <- mantel(matrices[[i]], matrices[[j]], permutations = 10000)
...
combined <- data.frame(
  ...
  p = round(p_melt$value, 3),
  label = paste0("r=", round(r_melt$value, 2), "\n", "p=", round(p_melt$value, 3))
)
...
ggplot(combined, aes(Var1, Var2)) +
  ...
  #scale_fill_gradient2(low = "blue", high = "red", mid = "white", midpoint = 0,
                       #name = "Mantel r") +
  scale_fill_viridis_c(option = "viridis", name = "Mantel r") +  # Use viridis color palette
  theme_minimal() +
  labs(x = "", y = "", title = "") +
