...
require("vegan"); require("reshape"); require("ggplot2"): require("tidyr"); require("dplyr"); require("dbstats"); require("reshape2"); require("ggpubr")
```
...
#For metegenomic data, make sample IDs rownames in a new data frame, to be further subsetted to numeric only data:
...
```{r Convert KO counts to relative abundance}
...
## Use GHG wrangling from Gina's code, instead of the following.
...
#require(dbstats) # run if dbstats not already loaded
