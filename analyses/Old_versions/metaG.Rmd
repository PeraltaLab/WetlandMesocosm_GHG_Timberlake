...
denit <- read.csv("~/GitHub/WetlandMesocosm_GHG_Timberlake/data/metaG/denitrif_metaGs_Functionfull74402_09-jun-2020.csv")
...
meth <- read.csv("~/GitHub/WetlandMesocosm_GHG_Timberlake/data/metaG/methane_metaGs_Functionfull129484_09-jun-2020.csv")
...
# Asks about this file

#resp <- read.csv("C:/Users/annorion/Documents/_Projects/2016_Timberlake/metaG/resp_metaGs_Functionfull6978_09-jun-2020.csv")
resp <- read.csv("~/GitHub/WetlandMesocosm_GHG_Timberlake/data/metaG/resp_metaGs_Functionfull6978_09-jun-2020.csv")
...
KO_list <- read.csv("~/GitHub/WetlandMesocosm_GHG_Timberlake/data/metaG/KO_list.csv")

#KO_functions <- read.csv("C:/Users/annorion/Documents/_Projects/2016_Timberlake/metaG/KO_Functions_list.csv")
KO_functions <- read.csv("~/GitHub/WetlandMesocosm_GHG_Timberlake/data/metaG/KO_Functions_list.csv")
...
#Sum of all gene counts within a functional group, grouped by design factors plant and treatment 
