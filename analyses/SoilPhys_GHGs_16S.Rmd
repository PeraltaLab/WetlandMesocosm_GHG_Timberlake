...
plot.CH4.flux.NPvP <- ggplot(select_fluxes_combined_w_T0, aes(x=plant, y=f0_CH4)) +
  ...
  #stat_compare_means(data = select_fluxes_combined_w_T0, method = "wilcox.test", paired = T, label = "p.signif", label.y.npc = "center", label.x.npc = "center",size = 10, hide.ns = T)
  stat_pvalue_manual(data = CH4_wilcox.DF, comparisons = list(c("N", "P")), label = "p.signif", size = 10, hide.ns = "p", y.position = 45, step.group.by = "date_format", bracket.size = 0)
