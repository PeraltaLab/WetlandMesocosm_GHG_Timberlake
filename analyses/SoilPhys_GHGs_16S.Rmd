...
plot.CH4.T30ppm.NPvP <- ggplot(ghg_ppm_filtered, aes(x=plant, y=ch4_ppm)) +
  ...
  theme(rect=element_rect(fill="transparent"))+
  theme(plot.background = element_rect(color=NA))+
  stat_compare_means(method = "wilcox.test", paired = T, label = "p.signif", label.y.npc = "center", label.x.npc = "center",size = 7, hide.ns = T)
...
CH4_multipleComparisons<- compare_means(ch4_ppm~treatment, ghg_ppm_filtered, group.by="date_short", method = "wilcox.test")
...
plot.CH4.T30ppm.Trt <- ggplot(ghg_ppm_filtered, aes(x=treatment, y=ch4_ppm)) +
  ...
  theme(text=element_text(size=14),axis.title=element_text(size=14,face="bold"),
          ...
          axis.text.x = element_text(angle = 0),panel.border = element_rect(colour = "black",size=1),strip.text = element_text(size = 14), legend.position="right", legend.title = element_text(size=14), legend.text=element_text(size=14)) + 
          theme(axis.ticks.length=unit(0.3,"cm")) + 
          labs(x = "Treatment", y = expression(paste("CH"[4]," (PPM)")), title="") +
  #scale_x_discrete(labels=c())+
  theme(rect=element_rect(fill="transparent"))+
  theme(plot.background = element_rect(color=NA))+
  #stat_compare_means(method = "kruskal.test", label = "p.format", label.y.npc = "top", label.x.npc = "left",size = 6, hide.ns = F)+
  stat_compare_means(method = "wilcox.test", comparisons = list(c("D", "I"), c("D", "W"), c("I", "W")), label = "p.signif", size = 7, vjust = 1, hide.ns = T)
...
CO2_multipleComparisons<- compare_means(co2_ppm~treatment, ghg_ppm_filtered, group.by="date_short", method = "wilcox.test")
...
plot.CO2.T30ppm.Trt <- ggplot(ghg_ppm_filtered, aes(x=treatment, y=co2_ppm)) +
  ...
  theme(text=element_text(size=14),axis.title=element_text(size=14,face="bold"),
          ...
          axis.text.x = element_text(angle = 0),panel.border = element_rect(colour = "black",size=1),strip.text = element_text(size = 14), legend.position="right", legend.title = element_text(size=14), legend.text=element_text(size=14)) + 
          theme(axis.ticks.length=unit(0.3,"cm")) + 
          labs(x = "Treatment", y = expression(paste("CO"[2]," (PPM)")), title="") +
  #scale_x_discrete(labels=c())+
  theme(rect=element_rect(fill="transparent"))+
  theme(plot.background = element_rect(color=NA))+
  #stat_compare_means(method = "kruskal.test", label = "p.format", label.y.npc = "top", label.x.npc = "left",size = 6, hide.ns = F)+
  #stat_compare_means(method = "wilcox.test", comparisons = list(c("D", "I"), c("D", "W"), c("I", "W")), label = "p.signif", size = 7, vjust = 1, hide.ns = T)+
  stat_pvalue_manual(data = CO2_multipleComparisons, comparisons = list(c("D", "I"), c("D", "W"), c("I", "W")), label = "p.adj", size = 7, vjust = 1, hide.ns = T, y.position = 2200)
...
N2O_multipleComparisons<- compare_means(n2O_ppm~treatment, ghg_ppm_filtered, group.by="date_short", method = "wilcox.test")
...
# Can I also save the significance level legend?
