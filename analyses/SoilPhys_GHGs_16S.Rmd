...
ghg_ppm <- ghg2 %>%
  dplyr::select('date', 'chamber', 'timepoint', 'plant', 'ch4_ppm', 'c2o_ppm', 'n2o_ppm')%>%
  dplyr::filter(date !='7/24/2016' & date != '6/13/2016')

# Fix c2o typo:
colnames(ghg_ppm)[6] <- "co2_ppm"
...
plot.CH4.plant <- ggplot(ghg.plant, aes(x=date_short, y=mg.CH4.N.m.2)) +
  ...
  theme(text=element_text(size=14),axis.title=element_text(size=14,face="bold"),
          ...
          panel.border = element_rect(colour = "black",size=1),strip.text = element_text(size = 14), legend.position="right", legend.title = element_text(size=14), legend.text=element_text(size=14)) + 
          theme(axis.ticks.length=unit(0.3,"cm")) + 
          labs(x = "Date", y = expression(paste("mg CH"[4],"-C m"^{-2})), title="") +
  theme(rect=element_rect(fill="transparent"))+
  theme(plot.background = element_rect(color=NA))+
  scale_y_continuous(limits = c(0, 175))
...
plot.CO2.plant <- ggplot(ghg.plant, aes(x=date_short, y=mg.CO2.N.m.2)) +
  ...
  theme(text=element_text(size=14),axis.title=element_text(size=14,face="bold"),
          ...
          panel.border = element_rect(colour = "black",size=1),strip.text = element_text(size = 14), legend.position="right", legend.title = element_text(size=14), legend.text=element_text(size=14)) + 
          theme(axis.ticks.length=unit(0.3,"cm")) + 
          labs(x = "Date", y = expression(paste("mg CO"[2],"-C m"^{-2})), title="") +
  theme(rect=element_rect(fill="transparent"))+
  theme(plot.background = element_rect(color=NA))+
  scale_y_continuous(limits = c(0, 180))
...
plot.N2O.plant <- ggplot(ghg.plant, aes(x=date_short, y=mg.N2O.N.m.2)) +
  ...
  theme(text=element_text(size=14),axis.title=element_text(size=14,face="bold"),
          ...
          panel.border = element_rect(colour = "black",size=1),strip.text = element_text(size = 14), legend.position="right", legend.title = element_text(size=14), legend.text=element_text(size=14)) + 
          theme(axis.ticks.length=unit(0.3,"cm")) + 
          labs(x = "Date", y = expression(paste("mg N"[2],"O-N m"^{-2})), title="") +
  theme(rect=element_rect(fill="transparent"))+
  theme(plot.background = element_rect(color=NA))+
  scale_y_continuous(limits = c(0, 1.6))
