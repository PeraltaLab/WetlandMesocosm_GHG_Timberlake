...
ch4.line.plot <- ggplot(df, x=date_format, y=f0_CH4)  +
  geom_point(aes(x=date_format, y=f0_CH4, color=treatment, shape=plant), size = 2) +
  scale_color_manual(values=c("#997700","#6699CC","#004488"), labels = c("Dry", "Interim", "Wet"), name="Treatment")+
  scale_shape_manual(values=c(1,19), labels = c("No Plant", "Plant"), name="")+
...
co2.line.plot <- ggplot(df, x=date_format, y=f0_CO2)  +
  geom_point(aes(x=date_format, y=f0_CO2, color=treatment, shape=plant), size = 2) +
  scale_color_manual(values=c("#997700","#6699CC","#004488"), labels = c("Dry", "Interim", "Wet"), name="Treatment")+
  scale_shape_manual(values=c(1,19), labels = c("No Plant", "Plant"), name="")+
...
n2o.line.plot <- ggplot(df, x=date_format, y=f0_N2O)  +
  geom_point(aes(x=date_format, y=f0_N2O, color=treatment, shape=plant), size = 2) +
  scale_color_manual(values=c("#997700","#6699CC","#004488"), labels = c("Dry", "Interim", "Wet"), name="Treatment")+
  scale_shape_manual(values=c(1,19), labels = c("No Plant", "Plant"), name="")+
...
GHG_flux_3panel <- ggarrange(ch4.line.plot, co2.line.plot, n2o.line.plot, labels = c("A", "B", "C"), ncol = 1, nrow = 3, legend = "top", common.legend = T, align = "hv")

GHG_flux_3panel

ggsave("../figures/Fe_S_manuscript/GHG_flux/LinePlot_Flux.tiff", plot=GHG_flux_3panel, device="tiff", path=NULL, scale=1, width=9, height=11, dpi=600, limitsize=TRUE, bg="white")
```
